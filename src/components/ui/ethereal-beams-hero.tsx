...
export default function EtherealBeamsHero() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black">
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex min-h-[calc(100vh-4rem)] items-center pt-[72px]">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm">Proje</div>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <div className="text-white/60 text-sm">Destek</div>
              </div>
            </div>
          </div>
        </div>
